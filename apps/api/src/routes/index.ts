...
import { facilityHandoversFlatRoutes } from "../modules/facilityHandovers/facilityHandovers.routes";
import { manifestsFlatRoutes } from "../modules/manifests/manifests.routes";
import { partnersRoutes } from "../modules/partners/partners.routes";
import { receivingReconciliationRoutes } from "../modules/receivingReconciliation/receivingReconciliation.routes";
...
router.use("/manifests", tenantResolver, authenticate, manifestsFlatRoutes);
router.use("/facility-handovers", tenantResolver, authenticate, facilityHandoversFlatRoutes);
router.use("/receiving-reconciliation", tenantResolver, authenticate, receivingReconciliationRoutes);
